<?php 
    ...
    if(isset($_POST['addabout'])){
        ...
        move_uploaded_file($tmp_name, "upload/aimage");
        $sql = "INSERT INTO about(title, content, image) VALUES ( 'title','content','aimage') ";
        $result = mysqli_query($con, $sql);
    
        if($result){
            $msg = '<p class="alert alert-success">insert is a success</p>';
        } else {
        $error = '<p class="alert alert-warnig">une  erreur est survenue</p>';
        }
